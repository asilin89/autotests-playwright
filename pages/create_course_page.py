...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.preview_image_upload_remove_button = page.get_by_test_id(
            "create-course-preview-image-upload-widget-remove-button"
        )
        self.preview_upload_input_image = page.get_by_test_id("create-course-preview-image-upload-widget-input")
    ...
    def check_visible_image_upload_view(self, is_image_uploaded: bool = False):
        ...
        if is_image_uploaded:
            expect(self.preview_image_upload_remove_button).to_be_visible()


    def click_remove_image_button(self):
        self.preview_image_upload_remove_button.click()
    ...
    def upload_preview_image(self,file: str):
        self.preview_upload_input_image.set_input_files(file)
